...
class MyEditor implements ActionListener
{
	...
	MyEditor()
	{
		jf=new JFrame("My Java Editor");
		jf.setLayout(null);
		jl=new JLabel("Enter the name of the class");
		jl.setBounds(50,20,230,25);
		jtf=new JTextField();
		jtf.setBounds(220,20,230,25);
		...
		jsp.setBounds(50,60,1020,450);
		jsp1.setBounds(50,560,1020,120);
		jf.add(jsp);
		jf.add(jsp1);

		jbcompile=new JButton("Compile");
		jbrun=new JButton("Run");
		jbcompile.setBounds(350,520,80,25);
		jbrun.setBounds(680,520,80,25);
		jf.add(jl);
		jf.add(jtf);
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		else if(e.getSource() == jbrun)
		{
	      ...
	      try
	      {
		       ...
		       Process p = r.exec("C:\\Program Files\\Java\\jdk1.8.0_131\\bin\\java.exe " + fn) ;
